...
RUN nuser=NUSER && npass=NPASS && \
   ...
   DEBIAN_FRONTEND=noninteractive apt-get install -y ncat wget nano curl sudo net-tools git openssh-server tmux dbus-x11 pciutils iproute2 iputils-ping bash-completion && \
