...
RUN nuser=NUSER && npass=NPASS && \
   ...
   DEBIAN_FRONTEND=noninteractive apt-get install -y netcat wget nano curl sudo net-tools netcat git openssh-server tmux dbus-x11 pciutils iproute2 iputils-ping bash-completion && \
